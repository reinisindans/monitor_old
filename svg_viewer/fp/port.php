...
<html lang="de">
<head>
	<title>Portale - IÖR-Flächenportal</title>
	<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Portale</li>
				</ol>
				<h3><i class="fa fa-bookmark-o"></i>&nbsp;&nbsp;Portale</h3>
				<p>Informationswebseiten und Planungsportale, die Wissen über das Thema Fläche bündeln und darstellen. Sie sammeln  hierzu Verweise auf Programme, Aktionen, Interessengruppen, praktische Beispiele und Methodenwissen.	 </p>
					...
					<div>
						<input type="text" class="bibtex_search form-control" id="searchbar" placeholder="Filtere Kategorie 'Portale' nach Autoren, Themen, Schlagwörtern,...">
