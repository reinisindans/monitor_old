		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active"><a href="upload.php">Upload Bibtex</a></li>
				</ol>
				...
				echo '<pre>';
				if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadfile) && $_FILES['userfile']['type']== 'application/x-bibtex' ) {
					echo "Datei ist valide und wurde erfolgreich hochgeladen.\n";
				} else {
					echo "Upload fehlgeschlagen, eventuell ist die Datei ist zu groß oder es wurde keine .bib-Datei gewählt.\n";
				}
