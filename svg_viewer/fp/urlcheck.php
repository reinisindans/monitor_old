...
//$str = json_decode($_POST['mydataa'], true); 
...
$results =utf8_encode($urllist);

  $results2 =  json_encode($results);

//$urllist = json_encode($_POST['mydataa']);
//var_dump(json_encode($urllist));

var_dump($results2);

if(isset($urllist) && !empty($urllist)) {
...
//$urllist = $_GET['mydata'];
//if($_POST['mydataa']){echo "ja ist da";}else{echo "kein post";}
if($urllist){echo "ja ist da";}else{echo "kein post";}
echo "hello";
