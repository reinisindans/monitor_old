...
<html lang="de">
<head>
	<title>Anwendungen - IÖR-Flächenportal</title>
	<meta charset="utf-8">
	...
	<div class="container">
		...
		<div id="navbar">
			<ul class="nav navbar-nav navbar-right" data-hover="dropdown" data-animations="fadeIn fadeIn">
				...
				<li><!--Suchfeld gibt Suchbegriff an search.php-->
...
<!--Falls Fehler im .bib auftreten, werden sie hier ausgegeben-->
<div id="bibtex_errors"></div>

<!--structure bestimmt welche Dokumente wie ausgegeben werden-->
<div class="bibtex_structure">
  <div class="sections bibtextypekey">  
	<!--Nur Dokumente ausgeben, die der Section "Anwendungen" zugehören (deren Zuweisung per Keyword erfolgt in parser.js); -->
 	 <div class="section @anwendungen" id="@ANWENDUNGEN">
	  <!--Dokumente nach Datum absteigend sortieren-->		
      <div class="sort date" extra="DESC string">
        <div class="templates"></div>
	  </div>
	  <!--Nach jeder Kategorie einen "nach oben" Link anbieten-->	
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active">Anwendungen</li>
				</ol>
					...
					<div class="media">
						<div class="media-body">								
							<div class="row">
								...
								<!--rechte Spalte mit kleinen Symbolen-->
						...
						<!--...und klappt Feld auf mit .bib Eintrag des Elements in linkem Bereich
