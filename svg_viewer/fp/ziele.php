...
<html lang="de">
<head>
	<title>Ziele - IÖR-Flächenportal</title>
	<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="searchbar">
					...
					<div>
						<input type="text" class="bibtex_search form-control" id="searchbar" placeholder="Filtere Kategorie 'Ziele' nach Autoren, Themen, Schlagwörtern,...">
				...
				<!--Template bestimmt Anordnung der Elemente; mit class=if... können Leere Zeilen vermieden werden
