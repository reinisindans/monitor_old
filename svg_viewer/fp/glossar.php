...
<html lang="de">
<head>
	<title>Glossar - IÖR-Flächenportal</title>
	<meta charset="utf-8">
	...
	<div class="container">
		...
		<div id="navbar">
			<ul class="nav navbar-nav navbar-right" data-hover="dropdown" data-animations="fadeIn fadeIn">
				...
				<li class="active"><a href="glossar.php">Glossar</a></li>
								...
								<div class="row">
									...
									<div class="col-sm-3 col-md-2">
										<ul class="list-unstyled first">
											...
											<li>	<!--Bootstrap collapse wird ausgelöst bei Klick auf diesen Link...-->
												<div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-4 col-md-3">
				...
				<ul>
					...
					<li><a href="news.php">Neuigkeiten</a></li>
					<li><a href="veranstaltungen.php">Veranstaltungen</a></li>
					<li><a href="glossar.php">Glossar</a></li>s
				</ul>
			</div>
