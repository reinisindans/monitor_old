...
// bei leerem Aufruf stoppen
// if(!$_SESSION['Dokument']['Fuellung']['Indikator_Einheit']) { echo "keine Daten."; die;}
...
<title>Statistische Kenngrößen - IÖR Monitor</title>
...
<div style="border: #999999 solid 0px; padding:10px; ">
  ...
  <tr>
                  <td valign="top" class="transp_hintergrund" style="width:200px; padding:0px;">
                        ...
                        <table style="width:800px; border:0px; border-collapse:collapse;">
                            <tr>
                              <td colspan="3" valign="bottom" class="grauer_hintergrund"><strong>Statistische Kenngrößen des Indikators: <?php echo $_SESSION['Dokument']['Fuellung']['Indikator_Beschreibung']; ?> (<?php echo $_SESSION['Dokument']['Jahr_Anzeige']; ?>)</strong></td>
                            </tr>
                            <tr>
                              <td colspan="2" valign="top" class="td_kopftabelle">Einheit:</td>
                              <td width="462" valign="top" class="td_kopftabelle"><?php echo $_SESSION['Dokument']['Fuellung']['Indikator_Einheit']; ?></td>
                         </tr>
                         <tr>
                        ...
                        <tr>
                            ...
                            <tr>
                              <td width="40" valign="top" class="td_kopftabelle"><div style="background-color:#33AA33;width:10px; height:10px;">&nbsp;</div></td>
                              <td width="282" valign="top" class="td_kopftabelle">Arithmetisches Mittel: &micro;</td>
                          ...
                          <tr valign="top">
                            ...
                            <td colspan="2" valign="top" class="td_kopftabelle">                            Falls die Grenzen der Standardabweichung über den Wertebereich hinaus reichen, werden diese Grenzen, in den obigen Angaben, durch das Minimum oder das Maximum des Wertebereichs ersetzt.</td>
                          </tr>
                ...
                <tr>
                  <td valign="bottom" class="transp_hintergrund" >&nbsp;</td>
                </tr>
                <tr>
                  <td valign="bottom" class="grauer_hintergrund" ><span class="transp_hintergrund"><strong>Histogramm:</strong></span></td>
                </tr>    
               <tr>
										...
										*/
                                        ...
                                        <div style=" line-height:0px; font-size:0px; background:#<?php 
												...
												*/
												...
												// .......... letztes Statement nötig um Anfangswert mit einzubeziehen (bleibt ansonsten außen vor)
        ...
        Bitte stellen Sie sicher, dass Ihr Browser darauf eingestellt ist, auch Hintergrundfarben zu drucken! <br />
 		...
 		<br />
		<br />
        <a  style="display:none;" href="tabelle_zur_karte_v3.php" target="_self" ><img src="../icons_viewer/back.png" alt="Zur&uuml;ck" /><br /> 
        &nbsp;zur&uuml;ck</a>
		<!--<span class="button_standard_abschicken_a" style="background:#BDDDFD;"><a href="tabelle_zur_karte_v3.php" target="_self">&nbsp;&nbsp;&nbsp;&lt;= Zurück zur Tabelle&nbsp;&nbsp;&nbsp;</a></span> -->
    	</span>
<br />
  		<br />
