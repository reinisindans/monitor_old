    ...
    tour = new Tour({
        steps:[
      {
        ...
        },
        {
          element: "#user_choice",
            ...
            onShow: function(){
              ...
              setTimeout(function(){setRaumgliederungFein('krs')},2000);
            },
            onNext: function () {
        ...
        },
        {
            ...
            onShow: function () {
                $('#legende').css("width", "300px");
                $('#legende_button').css("right", "300px");
                $('#dropdown_datenalter').show();
                $('#histogramm_pic').css("margin-left", "10px");
                //scroll down to view full viewport
                $("#legende").animate({ scrollTop: $('#legende').prop("scrollHeight")}, 100);
            },
            onNext: function () {
          ...
          element: '#vergleich_btn',
            title: "Vergleichsmodus",
                ...
                onNext:function(){
                    ...
                    setTimeout(function() {
                        $('#indicator_ddm_vergleich').dropdown('set selected', 'F01RG');
                    },2000);
                }
            },
            {
                ...
                onNext:function(){
                    setTimeout(function() {
                        $('#create_vergleichskarte_button').click();
                        setTimeout(function(){
                            openVergleichskarteDialog();
                        },2000);
                    },500);
